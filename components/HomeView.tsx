            ...
            <footer className="mt-16 py-16 border-t border-brand-primary/10 bg-[#020202] text-center">
                <RevealOnScroll animation="fade-up">
                    <div className="flex flex-col items-center gap-6">
                        <button onClick={handleInstallApp} className="text-[10px] text-green-400 font-orbitron tracking-widest uppercase flex items-center gap-2 hover:underline">
                            <AndroidIcon className="w-4 h-4" /> Install Mobile App
                        </button>
